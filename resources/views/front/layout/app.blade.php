...
<body>
    ...
    <div class="main-wrapper main-wrapper-1">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="widget-chart.html">Yöneticiler</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('publicatorListesi')}}">Aktif Yayın Evleri</a></li>
      ...
      <footer class="main-footer">
        <div class="footer-center">
          <a href="templateshub.net">Kütüphane Projesi</a></a>
        </div>
        <div class="footer-center">
        </div>
      </footer>
  ...
  <!-- General JS Scripts -->
   <!-- Bootstrap 5 JavaScript ve Popper.js -->
